...
const SEED_USERS = [
  { email: 'admin@fiap.com.br', role: 'ADMIN', name: 'Admin' },
  { email: 'student@fiap.com.br', role: 'STUDENT', name: 'Aluno' },
  { email: 'teacher@fiap.com.br', role: 'TEACHER', name: 'Professor' },
] as const
...
async function main() {
  ...
  try {
    ...
    for (const user of SEED_USERS) {
      await ensureUser(client, user.email, user.role, user.name)
    }
